...
from central_controller.core.math_utils import landmark_motion, phi, triangle_sdf
from central_controller.core.policy_net_att import PolicyNetAtt
...
class ModelBasedAgentAttRos:
    ...
    def reset_estimate_mu(self, mu_real):
        self._num_landmarks = int(mu_real.size()[0])
