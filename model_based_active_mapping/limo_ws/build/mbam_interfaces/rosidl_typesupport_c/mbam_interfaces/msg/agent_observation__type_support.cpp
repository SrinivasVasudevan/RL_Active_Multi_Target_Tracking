...
static const _AgentObservation_type_support_symbol_names_t _AgentObservation_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mbam_interfaces, msg, AgentObservation)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mbam_interfaces, msg, AgentObservation)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, mbam_interfaces, msg, AgentObservation)() {
  return &::mbam_interfaces::msg::rosidl_typesupport_c::AgentObservation_message_type_support_handle;
}
